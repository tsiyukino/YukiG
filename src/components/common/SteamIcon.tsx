/**
 * Steam logo icon as an inline SVG component.
 *
 * Renders the official Steam mark. Fill defaults to `currentColor` so it
 * inherits the surrounding text color, allowing use in nav links and buttons.
 *
 * @param size  - Width and height in pixels (default 16).
 * @param color - Fill color (default "currentColor").
 */
export default function SteamIcon({ size = 16, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg
      width={size}
      height={size}
